    ...
    (function () {
      ...
      var j = function (n) {
        var t,
          ...
          f = n.value,
          d = A((0, e.useState)(null != f ? f : ""), 2),
          p = d[0],
          m = d[1],
          h = A((0, e.useState)(0), 2),
          v = h[0],
          g = h[1],
          y = function (e) {
      ...
      var Q = function (n) {
            ...
            u =
              ...
              (function (e) {
                var n = {},
                  t = new Set();
                for (var r in e)
                  (n[r] = []), t.clear(), E(r, e, t), (n[r] = Array.from(t));
                return n;
              })(r)),
            c = B((0, e.useState)({}), 2),
            s = c[0],
            f = c[1],
            d = B((0, e.useState)(!1), 2),
            p = d[0],
            m = d[1],
            h = B((0, e.useState)(!1), 2),
            v = h[0],
            g = h[1],
            y = window.engraver;
          (0, e.useEffect)(function () {
          ...
          function S(e) {
            ...
            if (
              (e.render &&
                (function (e) {
                  var n = e.value,
                    t = e.valueObj,
                    r = e.functions;
                  p || (y.init("preview-canvas"), m(!0)),
                    v || (y.setProduct(a.initial_product_id), g(!0)),
                    r.forEach(function (e) {
                      switch (e.type) {
                        case "image":
                          ...
                          break;
                        case "text":
                          y.setText(Number(e.text_id), n);
                          break;
                        case "product":
                          y.setProduct(t.product_id);
                          break;
                        default:
              ...
              (w[n] = w[n] || 0 === w[n] ? w[n] : null),
              w[n] !== t && void 0 !== t)
            ) {
              var r,
                l = V(V({}, w), {}, $({}, n, t));
              if (u[n]) {
                for (var o = [], c = 0; c < b.length; c++) {
                  var s,
                    d = b[c];
                  u[n].includes(d.id)
                    ? (null === (s = u[d.id]) || void 0 === s
                        ? void 0
                        : s.length) > 1 &&
                      (k(u[d.id].slice(1), u[n]) || (l[d.id] = -1))
                    : o.push(d);
                }
                b = o;
              }
                  ...
                  if (0 !== t) {
                    ...
                    if (r) {
                      var a =
                        ...
                        })(l, r.conditions) && !r.hide_visually;
                      if (a) {
                        var o = b.find(function (e) {
                          return e.id === r.id;
                        });
                        o || b.push(V(V({}, r), {}, { renderId: n }));
                      }
                    }
                  }
                }),
                f({ renderedOption: b, formData: l });
            }
          }
          return e.createElement(
            "div",
          ...
          (0, e.useEffect)(
            function () {
              r &&
                ...
                fetch(
                  ""
                    .concat("https://sh.customily.com/api/settings/unified/")
                    .concat(r, "?shop=")
                    .concat(l)
                )
                  .then(function (e) {
                  ...
                  .then(function (e) {
                    console.log("api return: ", e), s(null != e ? e : {});
                  });
            },
            [r, l, a]
          ),
          ...
          (o = [
            {
              ...
              value: function () {
                ...
                (l.textContent =
                  ...
                  this.getAttribute("data-shop"),
                  n
                    .createRoot(t)
                    .render(
                      e.createElement(K, {
                        dataSlug:
                          "dear-dad-great-job-were-awesome-thank-you-father-gift-personalized-custom-t-shirt",
      ...
      customElements.define("eb-personalize", le);
    })();
})();
